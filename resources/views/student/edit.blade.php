...
@section('breadcrumb')
    ...
    <li><a href="{{ route('student.index') }}">Student <span class="mx-1">></span></a></li>
    <li><a> Create </a></li>
@endsection
@section('header')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white_shd full margin_bottom_30">
                ...
                <form class="padding_infor_info row" action="{{ route('student.update', $student->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                value="{{ old('name', $student->name) }}" name="name">
                            @error('name')
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="email" type="text" class="form-control @error('email') is-invalid @enderror"
                                value="{{ old('email', $student->email) }}" name="email">
                            @error('email')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="telephone" type="number"
                                ...
                                value="{{ old('telephone', $student->telephone) }}" name="telephone">
                            @error('telephone')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
