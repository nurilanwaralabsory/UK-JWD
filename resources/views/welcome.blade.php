...
<head>
  ...
  -->
    ...
    - favicon
  -->
    <link rel="shortcut icon" href="{{ asset('youdemi') }}/favicon.svg" type="image/svg+xml">

    <!--
    - custom font link
  -->
    <link rel="stylesheet" href="{{ asset('youdemi') }}/assets/font/font.css">

    <!--
    - custom css link
  -->
    <link rel="stylesheet" href="{{ asset('youdemi') }}/assets/css/style.css">

    <!--
    - preload images
  -->
    <link rel="preload" as="image" href="{{ asset('youdemi') }}/assets/images/hero-banner.png">
    <link rel="preload" as="image" href="{{ asset('youdemi') }}/assets/images/hero-bg.png">
...
<body>
  ...
  -->
    ...
    <header class="header" data-header>
        <div class="container">
            ...
            <a href="#" class="logo">
                <img src="{{ asset('youdemi') }}/assets/images/logo.svg" width="145" height="27"
                    alt="Youdemi home">
            </a>
            ...
            @if (Route::has('login'))
                <div style="display: flex; gap: 10px">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-secondary">Log
                            in</a>
    ...
    <main>
      ...
      -->
            ...
            <section class="section hero has-bg-image" aria-labelledby="hero-label"
                style="background-image: url('{{ asset('youdemi') }}/assets/images/hero-bg.png')">
                <div class="container">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('login') }}" class="btn btn-secondary">Get Started Now</a>
                        </div>

                    </div>

                    <figure class="hero-banner">
                        <img src="{{ asset('youdemi') }}/assets/images/hero-banner.png" width="590" height="620"
      ...
      -->
            ...
            <section class="section category has-bg-image" aria-labelledby="category-label"
                style="background-image: url('{{ asset('youdemi') }}/assets/images/category-bg.png')">
                <div class="container">
                    ...
                    <ul class="grid-list">
                            ...
                            <li>
                                <a href="">
                                    <div class="card category-card">
                                        ...
                                        <div class="card-icon">
                                            <img src="{{ asset('youdemi') }}/assets/images/category-1.svg"
                                                width="72" height="72" loading="lazy"
                                                alt="Data Science icon">
                                        </div>

                                        <div>
                                            <h3 class="title-lg">{{ $course->name }}</h3>
                        ...
                        {{-- <li>
                            <div class="card category-card">
                                ...
                                <div class="card-icon">
                                    <img src="{{ asset('youdemi') }}/assets/images/category-2.svg" width="72"
                                        height="72" loading="lazy" alt="UI/UX Design icon">
                                </div>
                        ...
                        <li>
                            <div class="card category-card">
                                ...
                                <div class="card-icon">
                                    <img src="{{ asset('youdemi') }}/assets/images/category-3.svg" width="72"
                                        height="72" loading="lazy" alt="Modern Physics icon">
                                </div>
                        ...
                        <li>
                            <div class="card category-card">
                                ...
                                <div class="card-icon">
                                    <img src="{{ asset('youdemi') }}/assets/images/category-4.svg" width="72"
                                        height="72" loading="lazy" alt="Music Production icon">
                                </div>
                        ...
                        <li>
                            <div class="card category-card">
                                ...
                                <div class="card-icon">
                                    <img src="{{ asset('youdemi') }}/assets/images/category-5.svg" width="72"
                                        height="72" loading="lazy" alt="Data Science icon">
                                </div>
                        ...
                        <li>
                            <div class="card category-card">
                                ...
                                <div class="card-icon">
                                    <img src="{{ asset('youdemi') }}/assets/images/category-6.svg" width="72"
                                        height="72" loading="lazy" alt="Finances icon">
                                </div>
            ...
            <section class="section about" aria-labelledby="about-label">
                <div class="container">
                    ...
                    <figure class="about-banner">
                        <img src="{{ asset('youdemi') }}/assets/images/about-banner.png" width="775"
                            height="685" loading="lazy" alt="about banner" class="w-100">
                    </figure>
      ...
      -->
            ...
            <section class="section course has-bg-image" aria-labelledby="course-label"
                style="background-image: url('{{ asset('youdemi') }}/assets/images/course-bg.png')">
                <div class="container">
                    ...
                    <ul class="grid-list">
                        ...
                        <li class="card-container">
                            <div class="card course-card">
                                ...
                                <figure class="card-banner">
                                    <img src="{{ asset('youdemi') }}/assets/images/course-1.png" width="370"
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="wrapper">
                                        ...
                                        <div class="rating-wrapper">
                                            <img src="{{ asset('youdemi') }}/assets/images/star-fill.svg"
                                    ...
                                    <div class="card-meta wrapper">
                                        ...
                                        <p class="title-sm">
                                            <img src="{{ asset('youdemi') }}/assets/images/file-outline.svg"
                                                width="20" height="20" loading="lazy" alt="">

                                            <span class="span">2 Lessons</span>
                                        </p>

                                        <p class="title-sm">
                                            <img src="{{ asset('youdemi') }}/assets/images/user-outline.svg"
                                                width="20" height="20" loading="lazy" alt="">
                        ...
                        <li class="card-container">
                            <div class="card course-card">
                                ...
                                <figure class="card-banner">
                                    <img src="{{ asset('youdemi') }}/assets/images/course-2.png" width="370"
                                        height="248" loading="lazy"
                        ...
                        <li class="card-container">
                            <div class="card course-card">
                                ...
                                <figure class="card-banner">
                                    <img src="{{ asset('youdemi') }}/assets/images/course-3.png" width="370"
                                        height="248" loading="lazy"
                        ...
                        <li class="card-container">
                            <div class="card course-card">
                                ...
                                <figure class="card-banner">
                                    <img src="{{ asset('youdemi') }}/assets/images/course-4.png" width="370"
                                        height="248" loading="lazy"
                        ...
                        <li class="card-container">
                            <div class="card course-card">
                                ...
                                <figure class="card-banner">
                                    <img src="{{ asset('youdemi') }}/assets/images/course-5.png" width="370"
                                        height="248" loading="lazy" alt="Logo Design: From Concept to Presentation"
                                        class="img-cover">
                                </figure>
                        ...
                        <li class="card-container">
                            <div class="card course-card">
                                ...
                                <figure class="card-banner">
                                    <img src="{{ asset('youdemi') }}/assets/images/course-6.png" width="370"
                                        height="248" loading="lazy"
  ...
  -->
    ...
    <footer class="footer has-bg-image"
        style="background-image: url('{{ asset('youdemi') }}/assets/images/footer-bg.png')">
        ...
        <div class="section footer-top">
            <div class="container">
                ...
                <div class="footer-brand">
                    ...
                    <a href="#" class="logo">
                        <img src="{{ asset('youdemi') }}/assets/images/logo-footer.svg" width="145"
                            height="27" alt="Youdemi home">
                    </a>
                    ...
                    <ul class="social-list">
                        ...
                        <li>
                            <a href="#" class="social-link">
                                <img src="{{ asset('youdemi') }}/assets/images/facebook.svg" width="40"
                                    height="40" loading="lazy" alt="facebook">
                            </a>
                        </li>

                        <li>
                            <a href="#" class="social-link">
                                <img src="{{ asset('youdemi') }}/assets/images/twitter.svg" width="40"
                                    height="40" loading="lazy" alt="twitter">
                            </a>
                        </li>

                        <li>
                            <a href="#" class="social-link">
                                <img src="{{ asset('youdemi') }}/assets/images/pinterest.svg" width="40"
                                    height="40" loading="lazy" alt="pinterest">
                            </a>
                        </li>

                        <li>
                            <a href="#" class="social-link">
                                <img src="{{ asset('youdemi') }}/assets/images/instagram.svg" width="40"
                                    height="40" loading="lazy" alt="instagram">
                            </a>
                        </li>
                ...
                <ul class="footer-list">
                    ...
                    <li>
                        ...
                        <ul class="grid-list">
                            ...
                            <li>
                                <img src="{{ asset('youdemi') }}/assets/images/ins-1.png" width="80"
                                    height="80" loading="lazy" alt="instagram post" class="img-cover">
                            </li>

                            <li>
                                <img src="{{ asset('youdemi') }}/assets/images/ins-2.png" width="80"
                                    height="80" loading="lazy" alt="instagram post" class="img-cover">
                            </li>

                            <li>
                                <img src="{{ asset('youdemi') }}/assets/images/ins-3.png" width="80"
                                    height="80" loading="lazy" alt="instagram post" class="img-cover">
                            </li>

                            <li>
                                <img src="{{ asset('youdemi') }}/assets/images/ins-4.png" width="80"
                                    height="80" loading="lazy" alt="instagram post" class="img-cover">
                            </li>

                            <li>
                                <img src="{{ asset('youdemi') }}/assets/images/ins-5.png" width="80"
                                    height="80" loading="lazy" alt="instagram post" class="img-cover">
                            </li>

                            <li>
                                <img src="{{ asset('youdemi') }}/assets/images/ins-6.png" width="80"
                                    height="80" loading="lazy" alt="instagram post" class="img-cover">
                            </li>
   ...
   - custom js link
  -->
    <script src="{{ asset('youdemi') }}/assets/js/script.js"></script>
